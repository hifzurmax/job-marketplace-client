...
const Banner = () => {
    return (
        <div className="hero max-w-7xl mx-auto min-h-screen font-poppins" style={{ backgroundImage: `url(${banner2})` }}>
                    ...
                    <form>
                        <div className="flex ">
                            ...
                            <div className="relative w-full">
                                <input type="search" id="search-dropdown" className="block outline-0 text-second focus:border-main p-2.5 w-full z-20 md:rounded-r-lg" placeholder="Frontend Developer, Logo designer..." required />
