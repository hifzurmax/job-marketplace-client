        ...
        <tr className="h-28 border rounded-lg hover:border-y-[#02af74] hover:text-main hover:-translate-y-1 hover: duration-300" key={_id}>
            <td className="text-second">
                ...
                <div className="flex gap-2 items-center">
                    ...
                    <div className="badge rounded-md bg-[rgba(4,133,101,.15)] text-[#048565]"><h2>Employee Email: {emailBidder}</h2>
                    </div>| <div className="pl-2 py-1 rounded-md bg-[rgba(4,133,101,.15)] text-[#048565]"><h2>Status: <span className="bg-main rounded text-white px-2 py-2">In Progress</span></h2>
                    </div>
                </div>
            </td>
            <th>
