            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <img src={logo} className="h-8 mr-3" alt="Task Hub Logo" />
                        <form className="flex items-center  mt-6">
                            ...
                            <button type="submit" className="inline-flex items-center py-2.5 px-3 ml-2 text-sm font-medium text-white bg-main rounded-md">
                                Subscribe
                            </button>
                        </form>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="#" className="hover:underline">TaskHub™</a>. All Rights Reserved.
                    </span>
